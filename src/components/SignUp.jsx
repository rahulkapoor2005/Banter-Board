...
function SignUp() {
    ...
    return (
        <div className='flex items-center justify-center'>
            <div className={`mx-auto w-full max-w-lg bg-black rounded-3xl p-10 border-4 border-white`}>
                ...
                <p className='mt-2 text-center text-base text-white/60 pb-6'>Already have an acount?&nbsp;
                    <Link
                    to="/login"
